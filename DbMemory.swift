...
////  SharedTODOList
////
////  Created by 이현승 on 2023/06/17.
////
//
//import Foundation
//class DbMemory: Database {
// 
//    private var storage: [Todo]  // 데이터 저장고
//
...
//            storage.append(Todo(date: date, withData: true))
//        }
//    }
//}
//
...
//        }else{
//            for i in 0..<storage.count{
//                if todo.key == storage[i].key{
//                    if action == .Delete{ storage.remove(at: i) }
//                    if action == .Modify{ storage[i] = todo }
//                    break
//                }
//            }
//        }
//        if let parentNotification = parentNotification{
//            parentNotification(todo, action)  // 변경된 내역을 알려준다
//        }
//    }
//}
